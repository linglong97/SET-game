...
Symbol can be 'a','s', or 'h', while shading can be 'sy'(symbol), 'l'(lowercase), or 'u'(uppercase).
'''
...
index: current index of (sets) which we are searching to find another disjoint SET from our current collection
